...
var columns = [
    ...
    {id: "shop_id", name: "购物ID", field: "shop_id"},
    {id: "name", name: "购物中文名", field: "name" ,width:100},
    {id: "name_en", name: "购物英文名", field: "name_en" ,width:100},
...
function batchOpt(option) {
	...
	if (confirm("确认将"+idList.length+"个购物状态改为"+optionStr+"吗？")) {
		var data = {
			idList: idList,
			option:option,
