...
var columns = [
	...
	{id: "total", name:"餐厅总数", field:"total"},
	{id: "online_total", name: "上线餐厅数",field: "online_total", width:100},
	{id: "comment_total", name: "有评论餐厅数", field: "comment_total", width:100},
	{id: "image_total", name: "有图片餐厅数", field: "image_total", width:100},
	...
	{id: "telphone_null", width:100 , name: "电话空比例", field: "telphone_null", width:100 },
	...
	{id: "cuisines_null", width:100 , name: "菜系空比例", field: "cuisines_null", width:100 },
	{id: "price_null", width:100 , name: "价格空比例", field: "price_null", width:100 },
	{id: "options_null", width:100 , name: "就餐选择空比例", field: "options_null", width:100 },
...
function makeTable(data) {
    ...
    data.forEach(function(line) {
        var obj = {
			...
			"telphone_null":line.telphone_null,
			"tag_null":line.tag_null,
			"tag_en_null":line.tag_en_null,
			"cuisines_null":line.cuisines_null,
			"price_null":line.price_null,
			"options_null":line.options_null,
        ...
        while(j--){
            if (idList[i] == sourceData[j].id) {
        		var obj = {
					...
					"telphone_null":sourceData[j].telphone_null,
					"tag_null":sourceData[j].tag_null,
					"tag_en_null":sourceData[j].tag_en_null,
					"cuisines_null":sourceData[j].cuisines_null,
					"price_null":sourceData[j].price_null,
					"options_null":sourceData[j].options_null,
