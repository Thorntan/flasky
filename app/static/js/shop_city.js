...
var columns = [
	...
	{id: "total", name:"购物总数", field:"total"},
	{id: "online_total", name: "上线购物数",field: "online_total", width:100},
	{id: "comment_total", name: "有评论购物数", field: "comment_total", width:100},
	{id: "image_total", name: "有图片购物数", field: "image_total", width:100},
        ...
        while(j--){
            if (idList[i] == sourceData[j].id) {
        		var obj = {
					...
					"name_bad":sourceData[j].name_bad,
					"name_en_null":sourceData[j].name_en_null,
					"name_en_bad":sourceData[j].name_en_bad,
					...
					"desc_bad":sourceData[j].desc_bad
        		};
                postData.push(obj);
                break;
            }
